              ...
              <table class="table table-striped" id="table">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?=base_url()?>Dosen/Nilai_pembekalan/get_peserta/<?=md5($r->id_kelompok)?>/<?=md5($r->id_ujipembekalan)?>/<?=$r->id_jadwal?>" class="btn btn-primary btn-xs btn-detail"><i class="fa fa-edit"></i> Input Nilai</a>
                    </td>
                  </tr>
                <?php
                  }
