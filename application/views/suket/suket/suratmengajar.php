<title>Surat Permohonan Mengajar</title>
<?php
...
<table width="100%" border="0"> 
	...
	<tr>
		...
		<td align="left" class="serif" width="1%">:</td>
		<td align="left" class="serif" width="65%">  Permohonan mengajar</td>
...
<table width="100%" border="0"> 
	<tr>
		<td align="justify" class="serif">Pertama-tama kami mengucapkan salam sejahtera kepada Pandita semoga dalam menjalankan kegiatan dan aktivitas sehari-hari senantiasa berada dibawah lindungan-Nya.</td>
	</tr>
</table>
<br>
<table width="100%" border="0"> 
	<tr>
		<td align="justify" class="serif">Sehubungan dengan dilaksanakannya perkuliahan Pendidikan Agama di Fakultas Teknik dan Ilmu Komputer Universitas Teknokrat Indonesia semester <?php echo $smt; ?>, kami mohon kesediaan Pandita untuk memberikan perkuliahan agama <?php echo $agama; ?> kepada mahasiswa di <?php echo $tempat; ?>. Mahasiswa tersebut adalah :</td>
	</tr>
</table>
<br>
<table width="100%" border="0"> 
...
<table width="100%" border="0"> 
	<tr>
		...
		<td align="left" class="serif" width="50%">
			Narahubung: <br>
			Rusliyawati, S.Kom., M.T.I. (081272530179)
		</td>
		<td align="left" class="serif" width="50%">&nbsp;</td>
	</tr>
</table>
