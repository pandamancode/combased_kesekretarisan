...
<div class="modal-header box-success box-solid" style="background-color:#00c0ef; color:white;">
    ...
    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-tag fa-fw"></i> <strong> Data Pengajuan Surat Keterangan</strong></h4>
</div>

<form method="POST" id="form_pengajuan" enctype="multipart/form-data" action="<?php echo base_url() ?>TU/Suket/pengajuan_action">
