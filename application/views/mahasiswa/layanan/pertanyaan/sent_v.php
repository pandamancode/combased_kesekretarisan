          ...
          <table class="table table-hover table-striped">
            ...
            foreach($sent->result() as $r){ ?>
              <tr>
                ...
                <td class="mailbox-name"><a href="<?=base_url()?>Mahasiswa/Layanan/pertanyaan/read_sent/<?=$r->no_pertanyaan?>"><?=$r->nama_mhs?></a></td>
                <td class="mailbox-subject"><a href="<?=base_url()?>Mahasiswa/Layanan/pertanyaan/read_sent/<?=$r->no_pertanyaan?>"><b><?=$r->nama_kategori?></b> - <?=$r->judul_pertanyaan?></a>
                </td>
                <td class="mailbox-date"><?=date('d-m-Y H:i',strtotime($r->tgl_pertanyaan))?> </td>
              </tr>
            <?php } }else{ ?>
              <tr>
