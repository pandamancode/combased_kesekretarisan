<div class="row">
  ...
  <div class="col-md-9">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Baca Pesan Pertanyaan</h3>
      </div>
      <div class="box-body no-padding">
        <div class="mailbox-read-info">
          ...
          ?>
            <span class="mailbox-read-time pull-right"><?php echo tgl_indo(date('Y-m-d',strtotime($read->tgl_pertanyaan))).' '.date('H:i',strtotime($read->tgl_pertanyaan)) ?></span></h5>
        </div>
