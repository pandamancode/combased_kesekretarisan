          ...
          <table class="table table-hover table-striped">
            ...
            foreach($inbox->result() as $r){ ?>
              <tr>
                ...
                <td class="mailbox-name"><a href="<?=base_url()?>Mahasiswa/Layanan/pengaduan/read/<?=$r->no_pengaduan?>"><?=$r->nama_staff?></a></td>
                <td class="mailbox-subject"><a href="<?=base_url()?>Mahasiswa/Layanan/pengaduan/read/<?=$r->no_pengaduan?>"><b><?=$r->nama_kategori?></b> - klik untuk melihat pesan</a>
                </td>
