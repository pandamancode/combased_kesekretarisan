<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel"><i class="fa fa-tag fa-fw"></i> Balas Pesan Pengaduan</h4>
</div>

<form method="post" action="<?php echo base_url() ?>Administrator/Layanan/Pengaduan/reply" enctype="multipart/form-data">
  ...
  <div class="modal-footer">
    <input type="hidden" name="id" value="<?=$pengaduan->no_pengaduan?>">
