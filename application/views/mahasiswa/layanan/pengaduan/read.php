    ...
    <div class="box box-primary">
      ...
      <div class="box-body no-padding">
        <div class="mailbox-read-info">
          ...
          ?>
            <span class="mailbox-read-time pull-right"><?php tgl_indo(date('Y-m-d',strtotime($read->tgl_pengaduan))).' '.date('H:i',strtotime($read->tgl_pengaduan)) ?></span></h5>
        </div>
...
<script type="text/javascript">
  ...
  $(document).on("click", ".btn-reply", function() {
    ...
    $.ajax({
      method: "POST",
      url: "<?php echo base_url('Mahasiswa/Layanan/pengaduan/mod_reply'); ?>",
      data: "id=" +id
    })
    .done(function(data) {
