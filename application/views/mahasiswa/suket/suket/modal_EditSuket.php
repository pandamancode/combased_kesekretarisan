<!-- Modal Form -->
           ...
           <form id="form-daftar-suket" method="POST" action="<?php  echo base_url('Mahasiswa/Suket/UpdateSuket'); ?>"> 
                      <?php
            ...
            <div class="modal-body" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 form-group">
                      	 <label >NPM </label>
                         <input type="text" class="form-control" name="npm" value="<?php echo $result_data->npm; ?>" readonly>
                      <input type="hidden" class="form-control" name="id" value="<?php echo $result_data->id_suket; ?>" readonly>
                      </div>
                      <div class="col-md-8 form-group">
                       	<label >Nama Mahasiswa </label>
                       <input type="text" class="form-control" name="nama" value="<?php echo $result_data->nama_mhs; ?>" readonly>  
                      </div>
                      <div class="col-md-6 form-group">
                        <label >Tempat Lahir </label>
                        <input type="text" class="form-control" name="tempatlhr" value="<?php echo $result_data->tempatlahir_mhs; ?>"  readonly>
                      ...
                      <div class="col-md-6 form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" class="form-control pull-right" id="datepicker" data-format="dd/MM/yyyy" readonly value="<?php echo nama_hari(date('Y-m-d',strtotime($result_data->tgllahir_mhs))).', '.tgl_indo(date('Y-m-d',strtotime($result_data->tgllahir_mhs))); ?>">
                        </div>
                      </div>
